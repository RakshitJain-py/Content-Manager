...
export function Sidebar({ accounts, selectedIds, onToggle, onAddAccount, onRemove }: SidebarProps) {
  return (
          ...
          return (
            <div key={account.id} className="group relative flex items-center">
              ...
              <button
                ...
                className="absolute right-3 opacity-0 group-hover:opacity-100 focus:opacity-100 p-1 text-neutral-500 hover:text-red-400 transition-all rounded"
